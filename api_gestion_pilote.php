...
if ($method === 'POST' && isset($_POST['action']) && $_POST['action'] === 'create') {
    ...
    try {
        ...
        $query = "INSERT INTO utilisateur (nom_utilisateur, prenom, email, password, role) 
                 VALUES (:nom, :prenom, :email, :password, 'pilote')";
...
elseif ($method === 'POST' && isset($_POST['action']) && $_POST['action'] === 'update') {
    ...
    try {
        ...
        $checkQuery = "SELECT Id_Utilisateur FROM utilisateur WHERE Id_Utilisateur = :id AND role = 'pilote'";
        $checkStmt = $pdo->prepare($checkQuery);
...
elseif ($method === 'POST' && isset($_POST['action']) && $_POST['action'] === 'delete') {
    ...
    try {
        ...
        // Delete the student
        $deleteQuery = "DELETE FROM utilisateur WHERE Id_Utilisateur = :id AND role = 'pilote'";
...
elseif ($method === 'GET' && isset($_GET['action']) && $_GET['action'] === 'list') {
    ...
    try {
        ...
        $countQuery = "SELECT COUNT(*) as total FROM utilisateur WHERE role = 'pilote'";
...
elseif ($method === 'GET' && isset($_GET['action']) && $_GET['action'] === 'internships') {
    ...
    try {
        ...
        $userQuery = "SELECT Id_Utilisateur FROM utilisateur WHERE email = :email AND role = 'pilote'";
